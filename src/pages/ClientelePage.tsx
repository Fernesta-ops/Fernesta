...
function ClientelePage() {
  return (
    <>
      <SeoMeta
        title="Industries We Serve | Fernesta Digital Marketing Agency"
        description="Fernesta works with SMEs, D2C brands, and growth-stage businesses worldwide seeking structured digital marketing systems and accountable execution."
        keywords="digital marketing agency industries, SME marketing, D2C marketing"
      />
      ...
      <section className="page-hero hero-clientele">
        ...
        <div className="container hero-grid hero-grid-single">
          <Reveal className="hero-copy" delayMs={80}>
            ...
            <h1>Digital Marketing Partner for SMEs, D2C Brands, and Growth Teams Worldwide.</h1>
            <p>
